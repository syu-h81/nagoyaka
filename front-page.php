    ...
    <dic class="p-top-beginning__inner l-inner">
      <div class="p-top-beginning__block">
        ...
        <div class="p-top-beginning__body__content u-sp-only">
          ...
          <div class="p-top-beginning__body__content__text">
            <p>
              医師が名古屋市内のご自宅に訪問をし、丁寧な診察と治療を行います。突<br class="u-pc-only">然の体調変化にも対応できますので、ご安心ください。
            </p>
            <p>
              「家で診療を受けたいけど、どうしたらいいの？」<br>
              「眼の治療も家でできるの？」
            ...
            <p>
              どんなことでもお気軽にご相談ください。患者様お一人おひとりに寄り<br class="u-pc-only">添った医療を提供いたします。
            </p>
          </div>
        </div>
      </div>
            ...
            <div class="p-top-flow__step__body">
              ...
              <div class="p-top-flow__step__body__phoneNumber footer-info-body__phoneNumber c-info-banner__phoneNumber">
                ...
                <div class="footer-info-body__phoneNumber__text c-info-banner__phoneNumber__text">
                  <p>お問い合わせ先：<br><span><a href="tel:050-8893-2767">050-8893-2767</a></span><br class="u-sp-only">　(平日 9:00〜18：00)</p>
